...
<body>
  ...
  <form method="post" action="adoptrep.php" enctype="multipart/form-data">
	...
	<div class="input-group">
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="report_adoption">Posteaza anuntul</button>
  	</div>
