...
<body>
  ...
  <form method="post" action="lostrep.php" enctype="multipart/form-data">
	...
	<div class="input-group">
      ...
      <div class="input-group">
  	  <label>Data la care a fost pierdut: </label>
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="report_lost">Posteaza anuntul</button>
  	</div>
