...
$result = mysqli_query($con,"SELECT * FROM lost");

echo "Lista animalelor date pierdute:";
echo "<br>";
...
while($row = mysqli_fetch_array($result))
{
    echo "<table border='2'>";
    echo "<tr>";
    echo "<td>";?> <img src="img/lost/<?php echo $row["image"]; ?>" height="150" width="200"> <?php echo "</td>";
    echo "</tr>";
    echo "<tr>";
    ...
    echo "</tr>";
	echo "<tr>";
    echo "<td> Data la care a fost pierdut: " . $row['date'] . "</td>";
    echo "</tr>";
    echo "<tr>";
