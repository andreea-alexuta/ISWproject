...
if (isset($_POST['report_found']) && isset($_FILES['image'])) {
  ...
  $contact = mysqli_real_escape_string($db, $_POST['contact']);
    ...
    else if (empty($location)) { array_push($errors, "Trebuie introdusă locația unde a fost găsit"); }
    else if (empty($date)) { array_push($errors, "Trebuie introdusă data la care a fost găsit"); }
